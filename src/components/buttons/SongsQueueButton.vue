<template>
  <div @click="$router.push({name: 'Queue'})">
    <svg width="26px" height="26px" viewBox="0 0 256 256" :stroke="color" :fill="color" stroke-width="2.2" xmlns="http://www.w3.org/2000/svg">
