<template>
  <div @click="toggleLikeSong">
    <svg xmlns="http://www.w3.org/2000/svg"
         :width="size" :height="size" viewBox="0 0 45.743 45.743"
         :style="{fill: color}"
         xml:space="preserve">
...
export default {
  ...
  methods: {
    toggleLikeSong() {
      if (!this.isLiked) return this.$store.dispatch('user/likeSong', this.songId);
      this.$store.dispatch('user/unlikeSong', this.songId);
    }
  }
}
</script>
